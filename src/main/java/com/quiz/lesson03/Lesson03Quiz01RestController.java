...
public class Lesson03Quiz01RestController {
	...
	// public List<RealEstate> selectRealEstateByRentPrice(@Param("rentPrice1") int
	// rentPrice);
	...
	// 요청 url : http://localhost:8080/lesson03/quiz01/2?rent_price=90 나는 300정도로
	// 설정...
//	@RequestMapping("/2")
...
//	}
	...
	public List<RealEstate> quiz01_3(
		...
		return realestateBO.getRealEstateListByAreaPrice(area, price);  //responsebody => json
	}
