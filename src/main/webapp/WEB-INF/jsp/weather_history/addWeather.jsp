...
<!-- jquery 원본: bootstrap, datepicker 사용하기 위해!!!! : jquery-3.6.0.js -->
...
<!-- 내가 만든 스타일시트 / 제일 하단에 있어야 우선적으로 적용 됨 -->
...
<body>
	...
	<script>
		//ready 함수 : DOM tree 가 완성된 후 불려지는 함수
		${document}.ready(function() {
			${"#date"}.datepicker({}); //{} : object ,js의 딕셔너리 사용해서 
